...
#best version wide
lmv.linkage.plot(map, "HG_QTL_thick.pdf", mapthese = c("1A","2A","2D","3A","4B","5B","7A"),
                 lgw = 0.2, pdf.height = 8, pdf.width = 12,
                 lgperrow = 4, lcol = "darkgray", rcol = "black", rfont=3, lfont=2,labdist = 0.1,
                 ...
                 showonly=c("S1A_6370170","S1A_535882457","S2A_1872142","S2A_771789729","S2D_22461473",
                            ...
                            "S7A_819439","S7A_715583205","S2A_1872142","S2D_17164152","S4B_559855530","S1A_6370170","S3A_621010472","S5B_78423903",
                            "S7A_13777429","S1A_520868230","S1A_531680970","S3A_613343859","S3A_616867989","S1A_8516115",
                            "S1A_512491739","S2A_13121298","S2D_17164152","S2D_18184603",
                            "S4B_541252759","S4B_565312655","S5B_87491939","S5B_81171755",
                            "S7A_6297132","S7A_653428241"
                 ))
...
locus <- c("S3A_613343859", "S3A_609909640","S3A_621010472")
font  <- c(4)   #bold italic
col <- c("red")
