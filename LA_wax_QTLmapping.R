# LA RIL pop - QTL Mapping 
#Glaucousness Phenotypes - Leaf + Spike
...
#import data
LAmap<-read.cross(format="csv",file="~/Wax/LAfinal/LAGenMap_wax.csv",estimate.map=FALSE,
                  na.strings=c(".","-","NA"),genotypes=c("A","B"),crosstype="riself")%>%jittermap(.)%>%calc.genoprob(map.function="kosambi")
summary(LAmap)

######## combined environment means - LEAF - col13 #########
#note naming is misleading for intermediate objects because cols 13 and 14 were switched

#col 13 = leaf

#determine LOD threshold
LAmaprobcom<- calc.genoprob(LAmap, step=1,map.function="kosambi",error.prob=0.001)#hidden Markov model
out.permLAcomspike<-scanone(LAmaprobcom,pheno.col=13,n.perm=1000, verbose=TRUE,method="em")#,model="normal")
summary(out.permLAcomspike, alpha=c(0.20,0.05))
...
#save LOD result
save(out.permLAcomspike, file = "LA-combloc-wax-spike-LODperm")

# SIM
SIMLAcomspike<-calc.genoprob(LAmap, step=1,map.function="kosambi",error.prob=0.001)
out.SIMLAcomspike<-scanone(SIMLAcomspike,pheno.col=13,model="normal",method="em")
summary(out.SIMLAcomspike,alpha=0.05,perms=out.permLAcomspike,format="tabByCol",pvalues=TRUE)%T>% {print(summary(.))}
save(out.SIMLAcomspike, file = "LA-combloc-wax-spike-SIM-obj")
#    Length Class      Mode
#lod 6      data.frame list
#c2D.loc38       2D  38     29      58  3.97 0.016
#c3A.loc163      3A 163    162     165 26.61 0.000
#S4B_635945715   4B 124     89     136  5.45 0.000
#c5B.2.loc19   5B.2  19      0      34  3.90 0.018

# CIM
#window size 6; 4 covariate markers
out.CIMLAcomspike<-cim(SIMLAcomspike,pheno.col=13, n.marcovar=4,method="em",window=6)#,map.function="kosambi",n.perm=1000)
summary(out.CIMLAcomspike,alpha=0.05,perms=out.permLAcomspike,format="tabByCol",pvalues=TRUE)%T>% {print(summary(.))}
save(out.CIMLAcomspike, file = "LA-combloc-wax-spike-CIM-obj")
#    Length Class      Mode
#lod 6      data.frame list
#chr   pos ci.low ci.high   lod   pval
#S2A_756951473  2A 105  56.00     105  3.95 0.016
#c2B.loc2       2B   2   1.31       8  3.87 0.020
#S3A_603900770  3A 163 162.00     165 30.88 0.000
#S4B_595211656  4B 108 105.17     112  5.52 0.000
#S6B_561009143  6B 134 130.00     188  4.23 0.008


#save QTL results
write.table(out.SIMLAcomspike,file="LA_combloc_waxspike_SIM.csv", sep = ",")
write.table(out.CIMLAcomspike,file="LA_combloc_waxspike_CIM.csv", sep = ",")

#### combined env leaf- col13-  PVE and EPISTASIS ####

setwd("C:/Users/Daniela/Documents/Wax/LAfinal/QTL-results")
#load(file = "LA-combloc-wax-spike-CIM-obj")

#2D
com.2D.SIM.spike.QTL<-makeqtl(LAmaprobcom,chr="2D",pos=38,qtl.name="c2D.loc38",what="prob")
com.2D.SIM.spike.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=13,qtl=com.2D.SIM.spike.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.2D.SIM.spike.QTL.Model)

#3A
com.3A.SIM.spike.QTL<-makeqtl(LAmaprobcom,chr="3A",pos=163,qtl.name="c3A.loc163",what="prob")
com.3A.SIM.spike.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=13,qtl=com.3A.SIM.spike.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.3A.SIM.spike.QTL.Model)

#4B
com.4B.SIM.spike.QTL<-makeqtl(LAmaprobcom,chr="4B",pos=124,qtl.name="S4B_635945715",what="prob")
com.4B.SIM.spike.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=13,qtl=com.4B.SIM.spike.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.4B.SIM.spike.QTL.Model)

#5B
com.5B.SIM.spike.QTL<-makeqtl(LAmaprobcom,chr="5B.2",pos=19,qtl.name="c5B.2.loc19",what="prob")
com.5B.SIM.spike.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=13,qtl=com.5B.SIM.spike.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.5B.SIM.spike.QTL.Model)

#CIM:

#2A
com.2A.CIM.spike.QTL<-makeqtl(LAmaprobcom,chr="2A",pos=105,qtl.name="S2A_756951473",what="prob")
com.2A.CIM.spike.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=13,qtl=com.2A.CIM.spike.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.2A.CIM.spike.QTL.Model)
#2B
com.2B.CIM.spike.QTL<-makeqtl(LAmaprobcom,chr="2B",pos=2,qtl.name="c2B.loc2",what="prob")
com.2B.CIM.spike.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=13,qtl=com.2B.CIM.spike.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.2B.CIM.spike.QTL.Model)
#3A
com.3A.CIM.spike.QTL<-makeqtl(LAmaprobcom,chr="3A",pos=163,qtl.name="S3A_603900770",what="prob")
com.3A.CIM.spike.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=13,qtl=com.3A.CIM.spike.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.3A.CIM.spike.QTL.Model)
#4B
com.4B.CIM.spike.QTL<-makeqtl(LAmaprobcom,chr="4B",pos=108,qtl.name="S4B_595211656",what="prob")
com.4B.CIM.spike.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=13,qtl=com.4B.CIM.spike.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.4B.CIM.spike.QTL.Model)
#6B
com.6B.CIM.spike.QTL<-makeqtl(LAmaprobcom,chr="6B",pos=134,qtl.name="S6B_561009143",what="prob")
com.6B.CIM.spike.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=13,qtl=com.6B.CIM.spike.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.6B.CIM.spike.QTL.Model)


## Fit a multiple-QTL model 
# CIM 
cimleafQTLs<- makeqtl(LAmaprobcom,chr=c("2A","2B","3A","4B","6B"),pos=c(105,2,163,108,134),
                       qtl.name=c("2A.leaf.QTL","2B.leaf.QTL","3A.leaf.QTL","4B.leaf.QTL","6B.leaf.QTL"),
                       what="prob")
cimleafQTL.model<- fitqtl(LAmaprobcom,pheno.col=13,qtl=cimleafQTLs,formula=y~Q1*Q2*Q3*Q4*Q5,method="hk")
summary(cimleafQTL.model)
# save results table to file
#newLAepistasisCIMcomb_leaf.txt

##old- for SIM model 
com_spikeQTLs<- makeqtl(LAmaprobcom,chr=c("2D","3A","4B", "5B.2"),pos=c(38,163,124,19),
                        qtl.name=c("com.2D.SIM.spike.QTL","com.3A.SIM.spike.QTL","com.4B.SIM.spike.QTL","com.5B.SIM.spike.QTL"),
                        what="prob")
com_spikeQTL.model<- fitqtl(LAmaprobcom,pheno.col=13,qtl=com_spikeQTLs,formula=y~Q1*Q2*Q3*Q4,method="hk")
summary(com_spikeQTL.model)
save(com_spikeQTL.model, file = "combloc-LA-wax-spike-SIMepistasis")
#### No Significant epistasis 


######## combined environment means - SPIKE - col14 #########
#note naming is misleading for intermediate objects because cols 13 and 14 were switched
...
#determine LOD threshold
LAmaprobcom<- calc.genoprob(LAmap, step=1,map.function="kosambi",error.prob=0.001)#hidden Markov model
out.permLAcomleafB<-scanone(LAmaprobcom,pheno.col=14,n.perm=1000, verbose=TRUE,method="em")#,model="normal")
summary(out.permLAcomleafB, alpha=c(0.20,0.05))
#LOD thresholds (1000 permutations)
#lod
#20% 2.78
#5%  3.40
#save LOD result
setwd("~/Wax/LAfinal/QTL-results")
save(out.permLAcomleafB, file = "combloc-LA-wax-leafB-LODperm")

# SIM
SIMLAcomleafB<-calc.genoprob(LAmap, step=1,map.function="kosambi",error.prob=0.001)
out.SIMLAcomleafB<-scanone(SIMLAcomleafB,pheno.col=14,model="normal",method="em")
summary(out.SIMLAcomleafB,alpha=0.05,perms=out.permLAcomleafB,format="tabByCol",pvalues=TRUE)%T>% {print(summary(.))}
save(out.SIMLAcomleafB, file = "combloc-LA-wax-leafB-SIM")
#    Length Class      Mode
#lod 6      data.frame list
#chr pos ci.low ci.high   lod  pval
#K1RS.6110     1B.1  0.0    0.0     6.0 17.60 0.000
#S2A_737386570   2A 73.5   68.0    77.0 16.51 0.000
#S4B_547093481   4B 95.4   85.3   128.0  3.98 0.015
#c4D.loc76       4D 76.0   69.0    80.8  8.85 0.000

# CIM
#window size 6; 4 covariate markers
out.CIMLAcomleafB<-cim(SIMLAcomleafB,pheno.col=14, n.marcovar=4,method="em",window=6)#,map.function="kosambi",n.perm=1000)
summary(out.CIMLAcomleafB,alpha=0.05,perms=out.permLAcomleafB,format="tabByCol",pvalues=TRUE)%T>% {print(summary(.))}
save(out.CIMLAcomleafB, file = "combloc-LA-wax-leafB-CIM")
#    Length Class      Mode
#lod 6      data.frame list
#chr   pos ci.low ci.high   lod   pval
#                  chr   pos ci.low ci.high   lod  pval
#S1A_33219502       1A  75.0     68    98.0  4.35 0.005
#c1B.1.loc1       1B.1   1.0      0     4.0 25.74 0.000
#S2A_737386570      2A  73.5     70    75.7 20.04 0.000
#K3W7_3A602018522   3A 161.8    159   168.0  5.80 0.001
#c4B.loc120         4B 120.0     87   125.7  4.31 0.005
#S4D_489467997      4D  80.8     77    80.8 10.60 0.000
#c6B.loc187         6B 187.0    184   187.7  5.11 0.002


#save QTL results
write.table(out.SIMLAcomleafB,file="LA_combloc_waxleafB_SIM.csv", sep = ",")
write.table(out.CIMLAcomleafB,file="LA_combloc_waxleafB_CIM.csv", sep = ",")
...
#### combined env spike - col14 - PVE and EPISTASIS ####
...
#1B.1  K1RS.6110
com.1B.SIM.leaf.QTL<-makeqtl(LAmaprobcom,chr="1B.1",pos=0,qtl.name="K1RS.6110",what="prob")
com.1B.SIM.leaf.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=14,qtl=com.1B.SIM.leaf.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.1B.SIM.leaf.QTL.Model)
#2A
com.2A.SIM.leaf.QTL<-makeqtl(LAmaprobcom,chr="2A",pos=73.5,qtl.name="S2A_737386570",what="prob")
com.2A.SIM.leaf.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=14,qtl=com.2A.SIM.leaf.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.2A.SIM.leaf.QTL.Model)
#4B
com.4B.SIM.leaf.QTL<-makeqtl(LAmaprobcom,chr="4B",pos=95.4,qtl.name="S4B_547093481",what="prob")
com.4B.SIM.leaf.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=14,qtl=com.4B.SIM.leaf.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.4B.SIM.leaf.QTL.Model)
#4D
com.4D.SIM.leaf.QTL<-makeqtl(LAmaprobcom,chr="4D",pos=76.0,qtl.name="c4D.loc76",what="prob")
com.4D.SIM.leaf.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=14,qtl=com.4D.SIM.leaf.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.4D.SIM.leaf.QTL.Model)


### CIM PVE

#1A
com.1A.CIM.leaf.QTL<-makeqtl(LAmaprobcom,chr="1A",pos=75.0,qtl.name="S1A_33219502",what="prob")
com.1A.CIM.leaf.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=14,qtl=com.1A.CIM.leaf.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.1A.CIM.leaf.QTL.Model)
#1B.1 
com.1B.CIM.leaf.QTL<-makeqtl(LAmaprobcom,chr="1B.1",pos=1.0,qtl.name="c1B.1.loc1",what="prob")
com.1B.CIM.leaf.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=14,qtl=com.1B.CIM.leaf.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.1B.CIM.leaf.QTL.Model)
#2A
com.2A.CIM.leaf.QTL<-makeqtl(LAmaprobcom,chr="2A",pos=73.5,qtl.name="S2A_737386570",what="prob")
com.2A.CIM.leaf.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=14,qtl=com.2A.CIM.leaf.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.2A.CIM.leaf.QTL.Model)
#3A
com.3A.CIM.leaf.QTL<-makeqtl(LAmaprobcom,chr="3A",pos=161.8,qtl.name="K3W7_3A602018522",what="prob")
com.3A.CIM.leaf.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=14,qtl=com.3A.CIM.leaf.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.3A.CIM.leaf.QTL.Model)
#4B
com.4B.CIM.leaf.QTL<-makeqtl(LAmaprobcom,chr="4B",pos=120.0,qtl.name="c4B.loc120",what="prob")
com.4B.CIM.leaf.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=14,qtl=com.4B.CIM.leaf.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.4B.CIM.leaf.QTL.Model)
#4D
com.4D.CIM.leaf.QTL<-makeqtl(LAmaprobcom,chr="4D",pos=80.8,qtl.name="S4D_489467997",what="prob")
com.4D.CIM.leaf.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=14,qtl=com.4D.CIM.leaf.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.4D.CIM.leaf.QTL.Model)
#6B
com.6B.CIM.leaf.QTL<-makeqtl(LAmaprobcom,chr="2A",pos=187.0,qtl.name="c6B.loc187",what="prob")
com.6B.CIM.leaf.QTL.Model<-fitqtl(LAmaprobcom,pheno.col=14,qtl=com.6B.CIM.leaf.QTL,formula=y~Q1,method="hk",get.ests=TRUE,dropone=TRUE)
summary(com.6B.CIM.leaf.QTL.Model)

# NEW -- CIM epistasis

cimspikeQTLs<- makeqtl(LAmaprobcom,chr=c("1A","1B.1","2A","3A","4B","4D","6B"),pos=c(75.0,1.0,73.5,161.8,120.0,80.8,187.0),
                      qtl.name=c("1A.spike.QTL","1B.spike.QTL","2A.spike.QTL","3A.spike.QTL","4B.spike.QTL","4D.spike.QTL","6B.spike.QTL"),
                      what="prob")
cimspikeQTL.model<- fitqtl(LAmaprobcom,pheno.col=14,qtl=cimspikeQTLs,formula=y~Q1*Q2*Q3*Q4*Q5*Q6*Q7,method="hk")
summary(cimspikeQTL.model)

# save results to file
# newLAepistasisCIMcomb_spike.txt
...
#S4B_547093481   4B 95.4   85.3   128.0  3.98 0.015
#c4D.loc76       4D 76.0   69.0    80.8  8.85 0.000
comleafQTLs<- makeqtl(LAmaprobcom,chr=c("1B.1","2A","4B","4D"),pos=c(0,73.5,95.4,76.0),
                      qtl.name=c("com.1B.SIM.leaf.QTL","com.2A.SIM.leaf.QTL","com.4B.SIM.leaf.QTL","com.4D.CIM.leaf.QTL"),
                      what="prob")
comleafQTL.model<- fitqtl(LAmaprobcom,pheno.col=14,qtl=comleafQTLs,formula=y~Q1*Q2*Q3*Q4,method="hk")
summary(comleafQTL.model)
save(comleafQTL.model, file = "combloc-LA-wax-leafB-SIMepistasis")
...
#best version thick box
lmv.linkage.plot(map, "LA_QTL_plot.pdf", mapthese = c("1A","1B.1","2A","2B","3A","4B","4D","6B"),
                 lgw = 0.2,
                 lgperrow = 4, lcol = "darkgray", rcol = "black", rfont=3, lfont=2,labdist = 0.1,roundpos = 0,
                 qtldf=qtldf, lg.col = "lightgray", rcex = 1, ruler = TRUE, pdf.height = 8, pdf.width = 12,
                 showonly=c("S1A_2856202","S1A_591147633","K1RS.6110","S1B_8697716","S1B_615019960",
                            "S2A_676266716","S2B_7648637","S2B_775604733",
                            "S3A_1003253","S3A_727764387","S4B_1056037","S4B_660521482",
                            "S4D_28548806","S4D_489467997","S6B_1328402","S6B_708668191",
                            "S1A_22922588","S1A_33236936","S2A_726107162","S2A_734831067",
                            "S2A_738782799","S2A_755807436","K3A_595963117","K3A_602018522","S3A_603900770",
                            "S3A_609909640","S3A_613343859","S4B_535242935","S4B_579470109","S4B_603520056",
                            "S4B_637471683","S4D_488834438","S6B_474215642","S2A_756951473","S2B_9713222",
                            "S2B_11077140","S4B_595211656","S6B_561009143","S1A_33219502","S2A_737386570",
                            "S4B_619589061","S4B_635945715","S4D_489467997","NCB_6B_698268853","S6B_708668191"
                 ))
####
#3A chrom only
...
locus <- c("K3A_602018522", "S3A_603900770")
font  <- c(3)   #italic
col <- c("red")
flist[[2]] <- list(locus = locus, font = font, col = col)
#make plot
lmv.linkage.plot(map, "LA_QTL_3A.pdf", mapthese = c("3A"),
                 lgperrow = 8, lcol = "darkgray", rcol = "black", rfont=3, lfont=1,
                 lg.col = "lightgray", rcex = 1, ruler = FALSE, pdf.height = 5,
                 markerformatlist = flist, labdist = 0.1,
                 showonly=c("S3A_1003253","S3A_727764387","K3A_595963117","K3A_602018522","S3A_603900770",
                            "S3A_609909640","S3A_613343859","S3A_621010472","K3A_575409079",
                            "S3A_623340292","S3A_623935828","S3A_627915876","K3A_587637075",
                            "S3A_574451562","S3A_567971108"
                 ))

#density plot
lmv.linkage.plot(map, "LA_density.pdf", denmap = TRUE)
